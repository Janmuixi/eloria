...
--> statement-breakpoint
INSERT INTO `__new_guest_menu_choices`("id", "guest_id", "course_id", "option_id", "for_plus_one", "created_at") SELECT "id", "guest_id", "course_id", "option_id", "for_plus_one", "created_at" FROM `guest_menu_choices`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `guest_menu_choices_guest_course_plusone_unq` ON `guest_menu_choices` (`guest_id`,`course_id`,`for_plus_one`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_guests`("id", "event_id", "name", "email", "phone", "rsvp_status", "plus_one", "plus_one_name", "token", "email_sent_at", "email_opened_at", "allergies", "plus_one_allergies", "created_at") SELECT "id", "event_id", "name", "email", "phone", "rsvp_status", "plus_one", "plus_one_name", "token", "email_sent_at", "email_opened_at", "allergies", "plus_one_allergies", "created_at" FROM `guests`;--> statement-breakpoint
...
CREATE TABLE `__new_tiers` (
	...
	`created_at` text DEFAULT '2026-05-06T18:55:18.632Z'
);
--> statement-breakpoint
