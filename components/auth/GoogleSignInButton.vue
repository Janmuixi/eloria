<template>
  <a
    ...
    class="w-full flex items-center justify-center gap-3 border border-charcoal-200 rounded-full py-2.5 font-medium text-charcoal-700 hover:bg-charcoal-50 hover:border-charcoal-300 transition-colors"
  >
