      ...
      <form @submit.prevent="saveSettings" class="bg-white rounded-xl border border-charcoal-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="md:col-span-2">
            <label class="block text-sm font-medium text-charcoal-700 mb-1">Event Title</label>
          ...
          <div>
            <label class="block text-sm font-medium text-charcoal-700 mb-1">Date</label>
            <input v-model="form.date" type="date" required
              class="w-full px-3 py-2 border border-charcoal-200 rounded-lg text-sm focus:border-champagne-500 focus:ring-2 focus:ring-champagne-500/20" />
          </div>

          <div>
            <label class="block text-sm font-medium text-charcoal-700 mb-1">Venue</label>
          ...
          <div>
            <label class="block text-sm font-medium text-charcoal-700 mb-1">Map URL</label>
