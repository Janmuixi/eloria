    ...
    <form @submit.prevent="onSubmit" class="bg-ivory-100 rounded-2xl p-8 shadow-sm border border-charcoal-200 space-y-4">
      ...
      <div>
        <div class="flex items-center justify-between mb-1">
          <label class="block text-sm font-medium text-charcoal-700">Password</label>
          <NuxtLink to="/auth/forgot-password" class="text-sm text-champagne-600 hover:text-champagne-500">Forgot password?</NuxtLink>
        </div>
